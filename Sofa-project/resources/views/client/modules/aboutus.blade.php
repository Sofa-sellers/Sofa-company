                ...
                <div class="col-xl-6 mb-4">
                    <div class="about-content text-center">
                        <div class="about-left-image">
                            <img src="assets/images/about/lg-1.jpg" alt="img" class="img-responsive">
                        </div>
            ...
            <div class="static_info">
                <div class="row mb-n4">
                    <div class="col-12 col-sm-6 col-lg-3 mb-4">
                        <div class="box_info">
                            <img src="assets/images/icon/1.jpg" alt="images_not_found">
                            <div class="txt_info">
                    ...
                    <div class="col-12 col-sm-6 col-lg-3 mb-4">
                        <div class="box_info">
                            <img src="assets/images/icon/2.jpg" alt="images_not_found">
                            <div class="txt_info">
                    ...
                    <div class="col-12 col-sm-6 col-lg-3 mb-4">
                        <div class="box_info">
                            <img src="assets/images/icon/3.jpg" alt="images_not_found">
                            <div class="txt_info">
                    ...
                    <div class="col-12 col-sm-6 col-lg-3 mb-4">
                        <div class="box_info">
                            <img src="assets/images/icon/4.jpg" alt="images_not_found">
                            <div class="txt_info">
        ...
        <div class="container">
            ...
            <div class="row mb-n5">
                <div class="col-sm-6 col-lg-3 mb-5">
                    <div class="service">
                        <div class="single-thumb mb-4">
                            <img src="assets/images/about/1.png" alt="single-thumb-naile">
                        </div>
                ...
                <div class="col-sm-6 col-lg-3 mb-5">
                    <div class="service">
                        <div class="single-thumb mb-4">
                            <img src="assets/images/about/2.png" alt="single-thumb-naile">
                        </div>
                        <div class="single-service">
                ...
                <div class="col-sm-6 col-lg-3 mb-5">
                    <div class="service">
                        <div class="single-thumb mb-4">
                            <img src="assets/images/about/3.png" alt="single-thumb-naile">
                        </div>
                        <div class="single-service">
                            <h3 class="service-title text-capitalize">Missa Santos</h3>
                ...
                <div class="col-sm-6 col-lg-3 mb-5">
                    <div class="service">
                        <div class="single-thumb mb-4">
                            <img src="assets/images/about/4.png" alt="single-thumb-naile">
                        </div>
                        <div class="single-service">
