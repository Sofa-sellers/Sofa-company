...
<nav class="breadcrumb-section breadcrumb-bg1">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <h2 class="bread-crumb-title">Privacy</h2>
    ...
    <section class="policy-section section-padding-bottom">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="policy-list">
                        <h3 class="policy-title">Who we are</h3>
                        <p>Our website address is: http://roadthemes.com/</p>
                    </div>
                    <div class="policy-list">
                        <h3 class="policy-title">What personal data we collect and why we collect it
                            Comments</h3>
                        <p class="mb-4">When visitors leave comments on the site we collect the data shown in the
                    ...
                    <div class="policy-list">
                        ...
                        <p>f you upload images to the website, you should avoid uploading images with embedded location
                    ...
                    <div class="policy-list">
                        ...
                        <p class="mb-4">If you leave a comment on our site you may opt-in to saving your name, email
                            ...
                            year.</p>
                        <p class="mb-4">If you have an account and you log in to this site, we will set a temporary
                            cookie to determine if your browser accepts cookies. This cookie contains no personal data
                            and is discarded when you close your browser.</p>
                        <p class="mb-4">When you log in, we will also set up several cookies to save your login
                            information and your screen display choices. Login cookies last for two days, and screen
                            options cookies last for a year. If you select “Remember Me”, your login will persist for
                    ...
                    <div class="policy-list">
                        ...
                        <p class="mb-4">Articles on this site may include embedded content (e.g. videos, images,
                            articles, etc.). Embedded content from other websites behaves in the exact same way as if
                    ...
                    <div class="policy-list">
                        ...
                        <p class="mb-4">If you leave a comment, the comment and its metadata are retained indefinitely.
